    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="商品图片" width="120" align="center">
          <template slot-scope="scope"><img style="height: 80px" :src="scope.row.images[0]" /></template>
        </el-table-column>
        ...
        <el-table-column label="审核状态" width="100" align="center">
          <template slot-scope="scope">
            <p>{{ xenum.PRODUCT_STATUS.toText(scope.row.status) }}</p>
            <!-- <p>
  ...
  methods: {
    ...
    getBrandList() {
      fetchBrandList({ pageNum: 1, pageSize: 100 }).then((response) => {
        this.brandOptions = []
        let brandList = response.data.result
